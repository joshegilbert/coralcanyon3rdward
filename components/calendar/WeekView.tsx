...
function eventsForDay(d: Date, events: EventRow[]) {
  return events
    .filter((e) => {
        ...
        {days.map((d, i) => {
          ...
          return (
            ...
            >
              <header
                className={cn(
                  "flex items-center justify-between gap-3 border-b border-border bg-muted/40 px-4 py-2.5",
                  sundayKind === "sunday_school" &&
                  ...
                  <span
                    className={cn(
                      ...
                      sundayKind === "sunday_school"
                        ...
                        : "bg-sky-200/70 text-sky-900 dark:bg-sky-900/50 dark:text-sky-100",
                    )}
                  >
                    {sundayKind === "sunday_school"
                      ? "Sunday School"
                  ...
                  dayEvents.map((e) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "block w-full rounded-lg px-3 py-2.5 text-left transition-colors active:brightness-95 cursor-pointer",
                          colors.pill,
                        )}
                      >
